package com.rmp.api.util.upload;
...
public class UploadUtils {
	...
	protected static final Logger log = LoggerFactory.getLogger(UploadUtils.class);
            		...
            		for (MultipartFile file : fileList) {
                        ...
                        if (fileName.trim() != "") {
                        	...
                        	if (maxSize != null 
                        		...
                        		AppException.toThrow(MSG_00020, new String[] {fileName, getFileSizeType(maxSize)});
                        	}
                        	...
                        	if (!StringUtils.isEmpty(suffixStr)) {
                        		List<String> suffixList = Lists.newArrayList(StringUtils.split(suffixStr, ","));
                        		if (suffixList != null && !suffixList.isEmpty()) {
                        			...
                        			if (!checkSuffix) {
                        				AppException.toThrow(MSG_00021, new String[] {fileName, suffixStr});
                        			}
                        		}
                        	}
	 ...
	 */
	public List<UploadBean> getUploadFiles(HttpServletRequest request, String name) {
                            ...
                            if (fileName.trim() != "") {
                            	...
                            	if (!StringUtils.isEmpty(suffixStr)) {
                            		...
                            		if (suffixList != null && !suffixList.isEmpty()) {
                            			...
                            			if (!checkSuffix) {
                            				AppException.toThrow(MSG_00022, new String[] {fileName, suffixStr});
                            			}
                            		}
                            	}
                            	uploadBean.setSuffix(suffix);
	...
	public void saveUploadFiles(UploadBean uploadBean, String dir, String path) throws Exception {
		...
		if (uploadBean != null) {
	        ...
	        try {
				...
				AppException.toThrow(e, MSG_00022);
			} catch (IOException e) {
				log.error(e.getMessage(), e);
				AppException.toThrow(e, MSG_00022);
			}
