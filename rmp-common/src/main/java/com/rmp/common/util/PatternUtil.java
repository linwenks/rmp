...
public class PatternUtil {
	 ...
	 * 包含
	 * @param str aaa 单字段
	 * @param contain 号码段 格式 : aaa|bbb|ccc
	 * 
	 * @return
	 */
	public static boolean matchesContain(String str, String contain) {
		boolean result = false;
		if(str != null && contain != null) {
			String regex = "(" + contain + ")$";
			result = Pattern.matches(regex, str);
		}
		return result;
	}
	...
	/**
	 * 包含2
	 * @param str bbbbbaaaccccc 整句
	 * @param contain 号码段 格式 : aaa|bbb|ccc
	 * 
	 * @return
	 */
	public static boolean matchesContain2(String str, String contain) {
		boolean result = false;
		if(str != null && contain != null) {
			String regex = ".*(" + contain + ").*$";
			result = Pattern.matches(regex, str);
