define({ "api": [
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求-示例: ",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"customerBean\":{\"id\":2},\"userRemindBean\":{\"advanceDate\":20190131}}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "data": [
          ...
          },
          {
            ...
            "type": "Object",
            "optional": false,
            "field": "customerDetailBean",
            "description": "<p>客户 明细 bean</p>"
          },
          {
            "group": "data",
            "type": "List",
            "optional": false,
            "field": "beanuserRemindBeanList",
            "description": "<p>客户 提醒 bean</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/api/customer/detail/get",
    "title": "客户 明细 查询",
    "description": "<p>客户 明细 查询</p>",
    "name": "customer_detail_get",
    "group": "group_customer",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "CustomerDetailBean": [
          {
            "group": "CustomerDetailBean",
            "type": "Object",
            "optional": false,
            "field": "customerDetailBean",
            "description": "<p>明细 bean</p>"
          },
          {
            "group": "CustomerDetailBean",
            "type": "Long",
            "optional": false,
            "field": "customerDetailBean.customerId",
            "description": "<p>客户ID</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "请求-示例: ",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"customerDetailBean\":{\"customerId\":2}}",
          "type": "json"
        }
      ]
    },
    "success": {
      "fields": {
        "data": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "customerDetailBean.remark",
            "description": "<p>备注</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "成功返回-示例:",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"msgs\":[],\"msg\":{},\"state\":\"0\",\"data\":{\"customerDetailBean\":{\"remark\":\"xxxxxxxxxTTT\"}}}",
          "type": "json"
        }
      ]
    },
    "filename": "D:/git_repository/rmp/rmp-api/src/main/java/com/rmp/api/controller/customer/CustomerDetailController.java",
    "groupTitle": "客户"
  },
  {
    "type": "post",
    "url": "/api/customer/detail/update",
    "title": "客户 明细 修改",
    "description": "<p>客户 明细 修改</p>",
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求-示例: ",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"customerDetailBean\":{\"customerId\":2,\"remark\":\"xxxxxxxxxTTT\"}}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "data": [
          ...
          },
          {
            ...
            "description": "<p>职业 值</p>"
          },
          {
            "group": "data",
            "type": "String",
            "optional": false,
            "field": "customerJobBean.office",
            "description": "<p>职位</p>"
          },
          {
            "group": "data",
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "成功返回-示例:",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"msgs\":[],\"msg\":{},\"state\":\"0\",\"data\":{\"customerProblemBean\":{\"healthCodeList\":[{\"key\":\"1\",\"value\":\"心脏病\"}],\"lifeCodeList\":[{\"key\":\"1\",\"value\":\"资金缺乏\"},{\"key\":\"3\",\"value\":\"事业发展\"}],\"health\":\"1\",\"life\":\"1,3\",\"remark\":\"xxxxxxxxxTTT\"}}}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求-示例: ",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"customerProblemBean\":{\"customerId\":2,\"healthCodeList\":[{\"key\":\"1\"}],\"lifeCodeList\":[{\"key\":\"1\"},{\"key\":\"3\"}],\"remark\":\"xxxxxxxxxTTT\"}}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求-示例: ",
          "content": "{\"header\":{\"token\":\"2661f2cac9754c98873aa9ce431b8012\"},\"userBean\":{\"realName\":\"ttt\",\"sex\":0,\"birthday\":20100101,\"headPic\":\"/xxx/pic.jpg\",\"area\":\"重庆市九龙坡区\",\"address\":\"aaaaaaaaaaaaaa\"},\"userJobBean\":{\"ndustry\":2,\"companyName\":\"aaaa\",\"departmentName\":\"bbb\",\"position\":3,\"office\":\"xxxxxx\",\"phone\":\"15111111111\",\"area\":\"重庆市九龙坡区\",\"address\":\"aaaaaaaaaaaaaa\"}}",
          "type": "json"
        }
      ]
    },
